...
(b=n.join(process.env.JAVA_HOME,"bin","java"+d.JAVA_EXT),h.existsSync(b)||(b=null));b||(b="java");return b};d.getBundledJava=function(){return n.normalize(n.join(__dirname,"jre","bin","java"+d.JAVA_EXT))};d.testJava=function(b,d){r.exec('"'+b+'" -version',{},function(b,h,c){c+="";c.match(/1\.[7-8]+/)?d(!0,null):0<=c.indexOf('version "')?d(!1,Error("Not Java 7")):d(!1,b)})};d.compile=function(b,h,m){(new d(h)).compile(b,m)};d.prototype.compile=function(b,p){function m(a,b){require("child_process").exec(a,
{c:20971520},b)}function q(a,b){m('"'+a+'" '+b,function(a,b,c){0<b.length||0<c.length?p(c+"",b+""):p(a,null)})}for(var c={},g=Object.keys(this.options),a=0;a<g.length;a++)c[g[a].toLowerCase()]=this.options[g[a]];delete c.js;delete c.js_output_file;var k='-XX:+TieredCompilation -jar "'+__dirname+'/compiler/compiler.jar"';b instanceof Array||(b=[b]);for(a=0;a<b.length;a++){if("string"!=typeof b[a]||0<=b[a].indexOf('"'))throw Error("Illegal source file: "+b[a]);e=h.statSync(b[a]);if(!e.isFile())throw Error("Source file not found: "+
