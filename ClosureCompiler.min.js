...
(a=null));a||(a="java");return a};d.getBundledJava=function(){return h.normalize(__dirname+h.sep+"jre"+h.sep+"bin"+h.sep+"java"+d.JAVA_EXT)};d.testJava=function(a,c){m.exec('"'+a+'" -version',{},function(a,d,h){0<=(""+h).indexOf('version "')?c(!0):c(!1)})};d.compile=function(a,c,h){(new d).compile(a,c,h)};d.prototype.compile=function(a,c,n){function m(a,b){require("child_process").exec(a,{c:20971520},b)}function p(a,b){m('"'+a+'" '+b,function(a,b,c){0<c.length?n(Error(""+c),null):a?n(a,null):n(null,
""+b)})}c=c||{};for(var e={},g=Object.keys(c),b=0;b<g.length;b++)e[g[b].toLowerCase()]=c[g[b]];c=e;delete c.js;delete c.js_output_file;var k='-jar "'+__dirname+'/compiler/compiler.jar"';a instanceof Array||(a=[a]);for(b=0;b<a.length;b++){if("string"!=typeof a[b]||0<=a[b].indexOf('"'))throw Error("Illegal source file: "+a[b]);e=l.statSync(a[b]);if(!e.isFile())throw Error("Source file not found: "+a[b]);k+=' --js "'+a[b]+'"'}c.a||(c.a=[]);c.a instanceof Array||(c.a=[c.a]);g=[];for(b=0;b<c.a.length;b++)if(e=
